...
const GRE = () => {
  ...
  const quizData = [
    { question: 'Question 1 : Which of the following is the closest synonym for "perfunctory"?'
     , options: ['Thorough', "Superficial", "You", "Arduous"]
     , correctAnswer: 1 },

    { question: 'Question 2 : In a right triangle, if one angle is 30 degrees and the hypotenuse is 10, what is the length of the side opposite the 30-degree angle?'
      , options: [" 5", "5√3", "10√3", "3"]
      , correctAnswer: 0 },

    { question: 'Question 3 : Which of the following words is most opposite in meaning to "placate"?'
      , options: ["Soothe", "Irritate", "Calm", "Reassure"]
      , correctAnswer: 1 },

    { question: 'Question 4 : If 3x-4=11, what is the value of x? '
      , options: ["3", "5", "7", "10"]
      , correctAnswer: 1 },


    { question: "Question 5 : The author's tone in the passage can best be described as:"
      , options: [" Neutral", "Enthusiastic", "Apathetic", "Critical"]
      , correctAnswer: 3 },

    { question: 'Question 6 : The word "esoteric" most nearly means:'
        , options: ["Commonplace", "Mysterious", "Simple", "Popular"]
        , correctAnswer: 1 },

   { question: "Question 7 : If the perimeter of a square is 20, what is the length of one side?"
          , options: ["4", "5", "10", "20"]
          , correctAnswer: 1 },

    { question: "Question 8 : Which of the following integers is a factor of both 60 and 72?"
            , options: ["4", "5", "6", "8"]
            , correctAnswer: 2 },

      { question: "Question 9 :The main idea of the passage is to:"
         , options: ["Argue against a popular theory", "Describe a new scientific discovery", "Provide a detailed history of an event", " Explain a complex process"]
              , correctAnswer: 3 },

       { question: "Question 10 : Which of the following fractions is equivalent to 0.75?"
